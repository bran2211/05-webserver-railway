...
http.createServer((req,res) => {
    ...
    console.log(req); //cada vez que accedamos al puerto 8080 va imprimir en consola el request
    /**
     ...
     * res.end();
     * 
     * Recargar la página y visiar las herramientas de desarrollador, ir a Network y 
     * evaluar los Headers
     */
